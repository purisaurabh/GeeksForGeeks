<h2><a href="https://practice.geeksforgeeks.org/problems/repetitive-addition-of-digits2221/1?page=2&difficulty[]=-1&category[]=Mathematical&sortBy=submissions">Repetitive Addition Of Digits</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size:18px">Given a non-negative integer <strong>N</strong>, repeatedly add all its digits until the result has only one digit.</span></p>
